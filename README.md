...
🤯 控制台应用默认不走代理，目前仅制作了在爬取下载链接阶段调用代理的支持：

🤯 若您有代理，可以将下载链接复制到您喜欢的浏览器或下载器中使用以享受满速下载，我将会在后续努力解决此问题。

🤯 若此应用在获取下载链接时闪退，请再次打开它进行尝试。

&ensp;&ensp;😟 若反复尝试后依旧不行，则大概率是因为您所在地区的DNS污染导致您无法正常访问Github。
